                    ...
                    <div class="container">
                        <div class="row justify-content-sm-center justify-content-lg-start text-lg-left">
                            <div class="col-md-10 col-lg-8 col-xl-5">
                                <div class="text-big-80 font-accent" data-caption-animate="fadeInDown" data-caption-delay="50" data-caption-duration="700">Best Green Eats</div>
                                <p class="text-big font-weight-bold offset-top-13" data-caption-animate="fadeIn" data-caption-delay="200" data-caption-duration="700">Health and Nutrition Coach. <br class="d-none d-lg-inline-block"> Yoga Teacher. Writer. Consultant.</p><a class="btn btn-white-outline offset-top-20 offset-sm-top-13 offset-lg-top-30" href="contact-me.html" data-caption-animate="fadeInUp" data-caption-delay="50" data-caption-duration="700">Subscribe</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-sm-center justify-content-lg-start text-lg-left">
                            <div class="col-md-10 col-lg-8 col-xl-6">
                                <div class="text-big-80 font-accent" data-caption-animate="fadeInDown" data-caption-delay="50" data-caption-duration="700">Enjoy a Healthy Life</div>
                                <p class="text-big font-weight-bold offset-top-13" data-caption-animate="fadeIn" data-caption-delay="200" data-caption-duration="700">With advice and methods available here, <br class="d-none d-lg-inline-block"> you can easily improve your life!</p><a class="btn btn-white-outline offset-top-20 offset-sm-top-13 offset-lg-top-30" href="contact-me.html" data-caption-animate="fadeInUp" data-caption-delay="50" data-caption-duration="700">Subscribe</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide" data-slide-bg="images/backgrounds/background-13-1920x900.jpg">
                <div class="swiper-slide-caption">
                    <div class="container">
                        <div class="row justify-content-sm-center justify-content-lg-start text-lg-left">
                            <div class="col-md-10 col-lg-8 col-xl-6">
                                <div class="text-big-80 font-accent" data-caption-animate="fadeInDown" data-caption-delay="50" data-caption-duration="700">Choose Your Diet</div>
                                <p class="text-big font-weight-bold offset-top-13" data-caption-animate="fadeIn" data-caption-delay="200" data-caption-duration="700">I can help you make your life healthier and your body stronger in no time.</p><a class="btn btn-white-outline offset-top-20 offset-sm-top-13 offset-lg-top-30" href="contact-me.html" data-caption-animate="fadeInUp" data-caption-delay="50" data-caption-duration="700">Subscribe</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-sm-center">
                    ...
                    <div class="col-md-8 col-lg-6 offset-top-34 offset-md-top-0">
                        <div class="inset-lg-left-50 inset-lg-right-50 inset-xl-left-50 inset-xl-right-50">
                            ...
                            <p class="text-big font-weight-bold text-gray offset-lg-top-40">A fresh & fun approach to your life <br class="d-none d-xl-inline-block"> health and happiness in your life.</p><a class="btn btn-primary offset-top-34" href="/about">More about me</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-95 main__features">
            <div class="container">
                ...
                <div class="row no-gutters justify-content-sm-center offset-top-40 shadow-drop-sm main__features__list">
                    <div class="col-md-6 col-lg-4"><img class="img-responsive img-fullwidth img-fullheight center-block" src="images/pages/events-01-390x289.jpg" width="390" height="289" alt=""></div>
                    <div class="col-md-6 col-lg-4">
                        <!-- Box-->
                        <div class="box-xs inset-xl-left-35 inset-xl-right-35"><span class="icon fl-great-icon-set-ico fl-great-icon-set-pencil107 text-primary"></span>
                            <p class="text-big font-weight-bold"><a class="link-decoration-none" href="blog-post.html">Seasonal diet</a></p>
                    ...
                    <div class="col-md-6 col-lg-4"><img class="img-responsive img-fullwidth img-fullheight center-block" src="images/pages/events-02-390x289.jpg" width="390" height="289" alt=""></div>
                    <div class="col-md-6 col-lg-4">
                        <!-- Box-->
                        <div class="box-xs inset-xl-left-35 inset-xl-right-35"><span class="icon fl-great-icon-set-ico fl-great-icon-set-video172 text-primary"></span>
                            <p class="text-big font-weight-bold"><a class="link-decoration-none" href="blog-post.html">Street workout</a></p>
                            <p>Daily movement, in some form, will make you feel better each and every day. Your body craves moment. It was built to move. That means, we need to find...</p>
                            <p class="text-big font-weight-bold offset-top-10">. . .</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <!-- Box-->
                        <div class="box-xs inset-xl-left-35 inset-xl-right-35"><span class="icon fl-great-icon-set-ico fl-great-icon-set-pencil107 text-primary"></span>
                            <p class="text-big font-weight-bold"><a class="link-decoration-none" href="blog-post.html">How to eat</a></p>
            ...
            <div class="container">
                ...
                <div class="row justify-content-sm-center offset-top-40 text-left">
                    <div class="col-md-8 col-lg-6">
                        <p class="text-big text-uppercase text-gray text-spacing-100 font-weight-bold">After 10 Days to Sugar Freedom you will:</p>
                        <!-- List Index-->
                        <ul class="list list-index font-weight-bold text-primary offset-top-13 offset-md-top-20">
                            ...
                            <li class="list-index-counter">Get back on track quickly after the occasional 'sugar binge' (it happens!)</li>
                        </ul>
                    </div>
                    <div class="col-md-8 col-lg-6 offset-top-40 offset-md-top-0">
                        ...
                        <ul class="list list-index font-weight-bold text-primary offset-top-13 offset-md-top-20">
                            ...
                            <li class="list-index-counter">Quick recipes and food suggestions to satisfy your sweet tooth (naturally)</li>
            ...
            <div class="row no-gutters justify-content-sm-center" style="font-size:0;">
                <div class="col-sm-10 col-md-8 col-lg-4 section-relative bg-image bg-image-3 bg-image-overlay bg-image-hover">
                    ...
                    <div class="box-offer box-offer-variant-2 context-dark">
                        <div class="box-offer-caption"><span class="icon icon-lg fl-great-icon-set-ico fl-great-icon-set-tree108"></span>
                            <h2 class="offset-top-10 offset-xs-top-20 offset-md-top-10 offset-xl-top-20">Healthy Eating is Not Hard</h2>
                            <p class="text-big font-weight-bold offset-top-5 offset-xs-top-10 offset-md-top-5 offset-xl-top-10">Tips for planning your nutritious diet.</p><a class="btn btn-white-outline offset-top-5 offset-xs-top-13 offset-md-top-5 offset-xl-top-13" href="welness.html">Click here</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-10 col-md-8 col-lg-4 offset-xs-top-30 offset-md-top-0 section-relative bg-image bg-image-4 bg-image-overlay bg-image-hover">
                    <!-- Box Offer-->
                    <div class="box-offer box-offer-variant-2 context-dark">
                        <div class="box-offer-caption"><span class="icon icon-lg fl-great-icon-set-ico fl-great-icon-set-tree108"></span>
                            <h2 class="offset-top-10 offset-xs-top-20 offset-md-top-10 offset-xl-top-20">The Best Fitness Advice and Info</h2>
                            <p class="text-big font-weight-bold offset-top-5 offset-xs-top-10 offset-md-top-5 offset-xl-top-10">Resource for health and fitness tips.</p><a class="btn btn-white-outline offset-top-5 offset-xs-top-13 offset-md-top-5 offset-xl-top-13" href="welness.html">Click here</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-10 col-md-8 col-lg-4 offset-xs-top-30 offset-md-top-0 section-relative bg-image bg-image-5 bg-image-overlay bg-image-hover">
                    <!-- Box Offer-->
                    <div class="box-offer box-offer-variant-2 context-dark">
                        <div class="box-offer-caption"><span class="icon icon-lg fl-great-icon-set-ico fl-great-icon-set-tree108"></span>
                            <h2 class="offset-top-10 offset-xs-top-20 offset-md-top-10 offset-xl-top-20">Tea Weight Loss Diet</h2>
                            <p class="text-big font-weight-bold offset-top-5 offset-xs-top-10 offset-md-top-5 offset-xl-top-10">Tea diet is a method of losing weight by drinking tea.</p><a class="btn btn-white-outline offset-top-5 offset-xs-top-13 offset-md-top-5 offset-xl-top-13" href="welness.html">Click here</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-sm-center offset-top-40">
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-6 offset-top-40 offset-lg-top-0 text-left">
                        <!-- Owl Carousel-->
                        <div class="owl-carousel owl-loaded" data-autoplay="true" data-items="1" data-stage-padding="15" data-loop="true" data-margin="30" data-mouse-drag="false" data-dots-custom=".owl-custom-pagination" data-nav="false" style="">



                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1140px, 0px, 0px); transition: all 0.25s ease 0s; width: 4020px; padding-left: 15px; padding-right: 15px;"><div class="owl-item cloned" style="width: 540px; margin-right: 30px;"><div class="owl-item">
                                        ...
                                        </div></div><div class="owl-item cloned" style="width: 540px; margin-right: 30px;"><div class="owl-item">
                                        ...
                                        </div></div><div class="owl-item active" style="width: 540px; margin-right: 30px;"><div class="owl-item">
                                        ...
                                        </div></div><div class="owl-item" style="width: 540px; margin-right: 30px;"><div class="owl-item">
                                            <p class="text-big font-weight-bold text-primary">Lola Jordon lost 20 pounds and 2 sizes</p>
                                            <p>Working with Joanna has allowed me to tune into how I eat, why I eat, and how it makes me feel. I'm more aware of times when I eat not because I'm hungry but because something else is bothering me or causing stress. Not focusing on food to make me feel better has improved my relationships with others and with myself.</p>
                                            <!-- Blockquote-->
                                            <blockquote class="quote quote-classic text-left offset-top-20 offset-md-top-25">
            ...
            <div class="container">
                ...
                <div class="row justify-content-sm-center offset-top-34">
                    <div class="col-md-10 col-lg-4">
                        <p class="text-big font-weight-bold text-primary">Jina Green lost 30 pounds and 3 sizes</p>
                        <p>I originally contacted Joanna because I was having trouble getting my eating habits under control, and was finally ready to admit that I couldn't do it on my own. After our initial consultation, I was convinced that if anyone could help, it was Joanna.</p><img class="img-responsive rounded-circle center-block offset-top-20 offset-md-top-30" src="images/users/user-jina-green-172x172.jpg" width="172" height="172" alt="">
                    ...
                    <div class="col-md-10 col-lg-4 offset-top-45 offset-md-top-0">
                        <p class="text-big font-weight-bold text-primary">Lola Jordon lost 20 pounds and 2 sizes</p>
                        <p>Working with Joanna has allowed me to tune into how I eat, why I eat, and how it makes me feel. I'm more aware of times when I eat not because I'm hungry but because something else is bothering me. Not focusing on food has improved my relationships with others.</p><img class="img-responsive rounded-circle center-block offset-top-20 offset-md-top-30" src="images/users/user-lola-jordon-172x172.jpg" width="172" height="172" alt="">
                        <div class="offset-top-13 offset-md-top-25">
                            <p class="font-weight-bold"><a class="link-decoration-none text-hover-primary text-gray" href="my-philosophy.html">Lola Jordon</a></p>
                        </div>
                        <div class="offset-top-0">
                    ...
                    <div class="col-md-10 col-lg-4 offset-top-45 offset-md-top-0">
                        <p class="text-big font-weight-bold text-primary">Rita Jefferson lost 10 pounds and 1 size</p>
                        <p>Joanna is unlike most nutritionists. She allows you to use foods that work with your lifestyle to address your concerns. I felt that I had a choice in what I ate and how I ate it rather than being on a strict diet. She was there with constant support.</p><img class="img-responsive rounded-circle center-block offset-top-20 offset-md-top-30" src="images/users/user-rita-jefferson-172x172.jpg" width="172" height="172" alt="">
                        <div class="offset-top-13 offset-md-top-25">
                            <p class="font-weight-bold"><a class="link-decoration-none text-hover-primary text-gray" href="my-philosophy.html">Rita Jefferson</a></p>
                        </div>
                        <div class="offset-top-0">
                ...
                <div class="bg-overlay-gray-darken">
                    <div class="container section-95">
                        <div class="jumbotron-custom jumbotron-custom-variant-3">
                            ...
                            <div class="group-xs offset-top-20 offset-lg-top-40"><a class="btn btn-primary" href="/catalog">Перейти в каталог</a><a class="btn btn-white-outline" href="contact-me.html">Заказать обратный звонок</a></div>
                        </div>
                    </div>
                </div>
            </div>
