  ...
  <main class="page-content diet__content">
      ...
      <div class="container">
        ...
        <div class="row d-flex offset-top-34">
          ...
          <div class="col-md-10 col-lg-4 offset-top-45 offset-md-top-0">
            ...
            <div class="col-9 p-0 ml-auto recommend-section__message">Для тех, кто питается продуктами исключительно
              растительного происхождения
            </div>
          </div>
          <div class="col-md-10 col-lg-4 offset-top-45 offset-md-top-0">
            <div class="col-2 p-0 text-big-80 font-weight-bold text-primary">3</div>
            <div class="col-9 p-0 ml-auto recommend-section__message">Кто совсем не имеет навыков приготовления
        ...
        <div class="row no-gutters justify-content-sm-center offset-top-40 shadow-drop-sm">
          <div class="col-md-6 col-lg-4">
            ...
            <div class="box-xs inset-xl-left-35 inset-xl-right-35"><span
              ...
              <p class="text-big font-weight-bold"><a class="link-decoration-none" href="blog-post.html">Цель
                  программы</a></p>
          ...
          <div class="col-md-6 col-lg-4">
            <!-- Box-->
            <div class="box-xs inset-xl-left-35 inset-xl-right-35"><span
                  class="icon material-icons-person  fl-great-icon-set-pencil107 text-primary"></span>
              <p class="text-big font-weight-bold"><a class="link-decoration-none" href="blog-post.html">Индивидуальный
                  подход</a></p>
      ...
      <div class="container">
        <div class="row justify-content-sm-center">
          <div class="col-md-10 col-xl-6">
            <h1>Меню</h1>
            <p class="text-big offset-top-34">With modern and intuitive interface of tabs and accordions, you can
              control contents to be organised within a single frame.</p>
      ...
      <div class="container">
        <div class="row justify-content-sm-center">
          <div class="col-md-8 col-lg-6 order-lg-1"><img class="img-responsive center-block"
                                                         src="/images/pages/home-01-570x350.jpg" width="570"
                                                         height="350" alt=""></div>
          <div class="col-md-8 col-lg-6 offset-top-34 offset-md-top-0">
            <div class="inset-lg-left-50 inset-lg-right-50 inset-xl-left-50 inset-xl-right-50">
              ...
              <p class="text-big font-weight-bold text-gray offset-lg-top-40">A fresh & fun approach to your life <br
                  ...
                  class="btn btn-primary offset-top-34" href="my-philosophy.html">More about me</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-sm-center offset-top-45">
          <div class="col-md-8 col-lg-4">
            ...
            <div class="box box-sm box-hover bg-default">
              <div class="box-hover-inner"><span
                    class="icon icon-lg fl-great-icon-set-ico fl-great-icon-set-coffee66 text-primary"></span>
                <p class="text-big font-weight-bold text-primary">Nutrition Strategy</p>
                <div class="box-hover-hidden">
                  <p class="offset-top-13">Get a simple, doable tweak to your habits, that will make you a healthy,
                    vibrant version of yourself.</p>
          ...
          <div class="col-md-8 col-lg-4 offset-top-30 offset-md-top-0">
            ...
            <div class="box box-sm box-hover bg-default">
              <div class="box-hover-inner"><span
                    class="icon icon-lg fl-great-icon-set-ico fl-great-icon-set-ball38 text-primary"></span>
                <p class="text-big font-weight-bold text-primary">Exercise Program</p>
                <div class="box-hover-hidden">
                  <p class="offset-top-13">Get your individual exercise program that will meet your special needs
                    considering your final goal.</p>
                  <p class="text-big font-weight-bold offset-top-5 text-primary">. . .</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-8 col-lg-4 offset-top-30 offset-md-top-0">
            ...
            <div class="box box-sm box-hover bg-default">
              <div class="box-hover-inner"><span
                    class="icon icon-lg fl-great-icon-set-ico fl-great-icon-set-alarm49 text-primary"></span>
                <p class="text-big font-weight-bold text-primary">Routine Program</p>
                <div class="box-hover-hidden">
                  <p class="offset-top-13">Our program is distinct in that it adopts a holistic approach to health
                    coaching based on your schedule.</p>
                  <p class="text-big font-weight-bold offset-top-5 text-primary">. . .</p>
                </div>
              </div>
            </div>
        ...
        <div class="bg-overlay-gray-darken">
          <div class="container section-95">
            ...
            <div class="jumbotron-custom jumbotron-custom-variant-3">
              ...
              <div class="group-xs offset-top-20 offset-lg-top-40"><a class="btn btn-primary"
                                                                      href="group-coaching.html">Read more</a><a
                    class="btn btn-white-outline" href="contact-me.html">Book a program</a></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="section-95">
      <div class="container">
        ...
        <a class="btn btn-width-200 btn-primary offset-top-13" href="contact-me.html">Subscribe to my blog</a>
      </div>
    </section>
    <!-- Our Skills-->
    <section class="context-dark"
             style="background: #191919 url(/images/backgrounds/background-03-1920x620.jpg) center/cover no-repeat;">
            ...
            <div class="col-md-8 col-lg-12">
              <div class="row justify-content-sm-center">
                <div class="col-sm-6 col-lg-3 col-xl-2">
                  <div class="inset-xl-left-25 inset-xl-right-25 inset-lg-left-25 inset-lg-right-25"><span
                        class="icon icon-xl fl-great-icon-set-ico fl-great-icon-set-diamond37"></span>
                    <!-- CountTo-->
                ...
                <div class="col-sm-6 col-lg-3 col-xl-2 offset-top-65 offset-xs-top-0">
                  <div class="inset-xl-left-25 inset-xl-right-25 inset-lg-left-25 inset-lg-right-25"><span
                        class="icon icon-xl fl-great-icon-set-ico fl-great-icon-set-portfolio36"></span>
                    <!-- CountTo-->
                ...
                <div class="col-sm-6 col-lg-3 col-xl-2 offset-top-65 offset-md-top-0">
                  <div class="inset-xl-left-25 inset-xl-right-25 inset-lg-left-25 inset-lg-right-25"><span
                        class="icon icon-xl fl-great-icon-set-ico fl-great-icon-set-sportive64"></span>
                    <!-- CountTo-->
                ...
                <div class="col-sm-6 col-lg-3 col-xl-2 offset-top-65 offset-md-top-0">
                  <div class="inset-xl-left-25 inset-xl-right-25 inset-lg-left-25 inset-lg-right-25"><span
                        class="icon icon-xl fl-great-icon-set-ico fl-great-icon-set-like77"></span>
                    <!-- CountTo-->
    ...
    <!-- Visit my shop-->
    <!-- Parallax-->
    <section class="section section-height-800 parallax-container"
             data-parallax-img="/images/backgrounds/background-07-1920x1019.jpg">
      <div class="parallax-content">
          ...
          <div class="row justify-content-sm-center">
            <div class="col-sm-10 col-md-8">
              ...
              <div class="box-sm bg-default">
                ...
                <p class="text-big text-gray offset-top-13">You will find many interesting things that can strengthen
                  your body</p><a class="btn btn-primary offset-top-13" href="shop-category.html">Click here</a>
              </div>
            </div>
          </div>
        </div>
